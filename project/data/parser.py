...
# Regular expressions to identify crop types and data rows
crop_type_pattern = re.compile(r"^[A-Z ]+ \(.*\)")
data_row_pattern = re.compile(r"^[A-Za-z].*:")

# Initialize storage for parsed data
parsed_data = []
current_crop_type = None

# Function to parse a line based on fixed column widths
def parse_line(line):
    ...
    try:
        ...
        return {
            ...
            "2022_farms": farms_2022 if farms_2022 != "-" else None,
            "2022_acres": acres_2022 if acres_2022 != "-" else None,
            "2022_quantity": quantity_2022 if quantity_2022 != "-" else None,
            "2022_irrigated_farms": irrigated_farms_2022 if irrigated_farms_2022 != "-" else None,
            "2022_irrigated_acres": irrigated_acres_2022 if irrigated_acres_2022 != "-" else None,
            "2017_farms": farms_2017 if farms_2017 != "-" else None,
            "2017_acres": acres_2017 if acres_2017 != "-" else None,
            "2017_quantity": quantity_2017 if quantity_2017 != "-" else None,
            "2017_irrigated_farms": irrigated_farms_2017 if irrigated_farms_2017 != "-" else None,
            "2017_irrigated_acres": irrigated_acres_2017 if irrigated_acres_2017 != "-" else None,
        }
    except IndexError:
